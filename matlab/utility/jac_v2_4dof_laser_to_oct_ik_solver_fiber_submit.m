...
function [ fi, Jacobian_matrix ] = jac_v2_4dof_laser_to_oct_ik_solver_fiber_submit( traj_w )
    ...
    for idx_traj = 1 : num_of_waypoint
        ...
        % prepare data
        pi_tmp = pts_org_init_gt_fiber + ( alpha_x_opt_fiber + beta_x ) * list_of_vx_calib_fiber' + ...
                                          ( alpha_y_opt_fiber + beta_y ) * list_of_vy_calib_fiber';
        ...
        % point offsets 
        fi = fi + norm( pts_fk - list_of_target_ik_pts_fiber(idx_traj, :)' ).^2;
